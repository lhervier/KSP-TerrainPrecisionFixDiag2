...
Part of [Terrain Precision Fix Diag 2](../README.md): how to take the reading yourself, step by step. The columns it fills are in [The window](the-window.md), and the readings it produced are in [Six loadings of the same save](six-loadings-of-the-same-save.md).
